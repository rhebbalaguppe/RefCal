...
def cvt_7_3_32(pretrained=False, progress=False,
                    img_size=32, positional_embedding='learnable', num_classes=10,
                    *args, **kwargs):
...
cvt_model_dict = {
    ...
    "cvt_7_3_32" : cvt_7_3_32,
}

def _get_cvt(model, dataset):
    if dataset == "cifar10":
        return cvt_model_dict[model](num_classes=10)
    elif dataset == "cifar100":
        return cvt_model_dict[model](num_classes=100)
